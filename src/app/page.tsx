...
export default function Home() {
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="flex flex-row gap-x-4 mb-8 dark:fill-white">
        <a href="https://www.linkedin.com/connorpark-24">
          <svg viewBox="0 0 24 24" className="lg:h-8 lg:w-8 w-6 h-6 ">
        ...
        <a href="https://www.github.com/connorpark24">
          <svg
            viewBox="0 0 24 24"
            aria-hidden="true"
            className="lg:h-8 lg:w-8 w-6 h-6 dark:fill-white"
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      <div className="flex flex-row">
        <div className="text-base flex flex-col gap-y-8 w-3/5 leading-7 text-neutral-600 dark:text-gray-300">
          <p>
            ...
            of Michigan. I am also working toward minors in Mathematics and
            Business.
          </p>
          <p>
